...
@interface JYNSUIViewController ()
...
@implementation JYNSUIViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    // 1. 初始化数据
    NSString *path = [[NSBundle mainBundle] pathForResource:@"UIComponents" ofType:@"plist"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    titileString = [NSString stringWithFormat:@"%ld",(long)[indexPath row] + 1 + (long)[indexPath section]*100];
