...
- (void)launchFirework{
    ...
    flare.contents = (id)[UIImage imageNamed:@"tspark"].CGImage;
    ...
    firework.contents = (id)[UIImage imageNamed:@"tspark"].CGImage;
    ...
    spark.contents = (id)[UIImage imageNamed:@"tspark"].CGImage;
    spark.lifetime = 0.05;
